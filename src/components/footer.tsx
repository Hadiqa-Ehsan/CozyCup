    ...
    <footer className="relative bg-[#3D2E24] text-[#F4F6F0] py-12 px-6 border-t border-[#98AB81]/20">
      <div className="mx-auto max-w-7xl grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#98AB81] text-[#3D2E24]">
                  <Phone className="h-4 w-4" />
                </div>
                <div>
                  <p className="text-[11px] font-bold uppercase text-[#F4F6F0]/60 tracking-wide">PHONE</p>
                  <p className="font-semibold text-[#F4F6F0]">+923004805000</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[11px] font-bold uppercase text-[#F4F6F0]/60 tracking-wide">EMAIL</p>
                  <p className="font-semibold text-[#F4F6F0]">Info@CozyCup.com.pk</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[11px] font-bold uppercase text-[#F4F6F0]/60 tracking-wide">ADDRESS</p>
                  <p className="font-semibold text-[#F4F6F0] leading-snug">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {/* Timing Cards */}
          <div className="space-y-3 text-sm">
            <div className="flex justify-between items-center rounded-xl border border-[#98AB81]/20 bg-[#F4F6F0] p-3.5 shadow-sm text-[#3D2E24]">
              <span className="font-bold">Monday - Thursday</span>
              <span className="font-semibold">09:00 AM - 12:30 AM</span>
            </div>

            <div className="flex justify-between items-start rounded-xl border border-[#98AB81]/20 bg-[#F4F6F0] p-3.5 shadow-sm text-[#3D2E24]">
          ...
          <div className="flex gap-3 text-sm pt-1">
            <Link
              href="/terms"
              className="rounded-xl border border-[#98AB81] bg-[#98AB81] px-4 py-2 text-[#3D2E24] font-bold hover:bg-[#F4F6F0] transition shadow-sm"
            >
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="flex gap-2.5 items-center">
              ...
              <Link href="#" aria-label="Facebook">
                <div className="w-9 h-9 rounded-xl bg-[#1877F2] flex items-center justify-center text-white hover:opacity-90 transition">
              ...
              <Link href="#" aria-label="Instagram">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] flex items-center justify-center text-white hover:opacity-90 transition">
              ...
              <Link href="#" aria-label="X">
                <div className="w-9 h-9 rounded-xl bg-[#F4F6F0] flex items-center justify-center text-[#3D2E24] hover:bg-[#98AB81] transition">
              ...
              <Link href="#" aria-label="LinkedIn">
                <div className="w-9 h-9 rounded-xl bg-[#0A66C2] flex items-center justify-center text-white hover:opacity-90 transition">
              ...
              <Link href="#" aria-label="Snapchat">
                <div className="w-9 h-9 rounded-xl bg-[#FFFC00] flex items-center justify-center text-black hover:opacity-90 transition">
            ...
            <div className="flex gap-3 pt-2">
              <Link href="#" className="inline-block">
                <div className="bg-[#F4F6F0] text-[#3D2E24] px-3 py-1.5 rounded-lg flex items-center gap-2 border border-[#98AB81]/30 hover:bg-[#98AB81] transition">
      ...
      <button
        ...
        className="absolute bottom-6 right-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#98AB81] text-[#3D2E24] shadow-md hover:bg-[#F4F6F0] transition"
