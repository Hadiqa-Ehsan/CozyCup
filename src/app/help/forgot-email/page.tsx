        ...
        <div className="relative w-full rounded-[22px] bg-[#F6F4EB] p-7 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              />
              <p className="text-[10px] text-gray-400">Example: +923XX-XXXXXXX</p>
            </div>
